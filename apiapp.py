...
with gr.Blocks() as demo:
    with gr.Row():
        ...
        rad1=gr.Radio(["2", "5"], value=astate.current_pot, label="Ванна", info="Для какого обьекта производятся измерения")
    ...
    with gr.Row():
        with gr.Column(scale=2, min_width=300):
            ...
            rad2=gr.Radio(["Увеличить", "Уменьшить", "Не менять"], label="Ванна", info="Подача")
